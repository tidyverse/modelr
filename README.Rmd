...
[![CRAN status](https://www.r-pkg.org/badges/version/modelr)](https://cran.r-project.org/package=modelr)

The modelr package provides functions that help you create elegant pipelines when modelling. 
It is designed primarily to support teaching the idea of modelling within the tidyverse, particularly in [R for data science](http://r4ds.had.co.nz/model-basics.html).
